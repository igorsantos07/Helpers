...
/**
 * Yet another utility class for dates. Does what DateTime can't do.
 * Originally based on https://github.com/igorsantos07/Yii-Extensions/blob/master/helpers/DateHelper.php
 * @todo not completely migrated, be aware of bad doc!
 *
 * @see https://github.com/igorsantos07/Yii-Extensions/blob/master/helpers/DateHelper.php
	...
	public static function convert($originalDate, $from = 'BR', $to = 'ISO') {
		...
		//monta um array no formato (0 => 'd', 1 => 'm', 2 => 'Y', '/' => 'sep') para depois ter as chaves trocadas com os valores e tudo isso virar variável
       	switch (strtoupper($from)) {
			...
			case 'US'	:
			case 'USA'	: $parts = ['m','d','Y', '/' => 'sep']; break;
			case 'EU'	: $parts = ['d','m','Y', '.' => 'sep']; break;
			default:
